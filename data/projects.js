...
export const portfolioSections = [
  {
    id: 'fashion-films',
    label: 'Fashion Films',
    intro: 'Selected fashion film, editorial motion and visual pieces.',
    items: [
  ...
  },
  {
    id: 'clothing',
    label: 'Clothing',
    intro: 'Edited clothing and brand-led motion pieces.',
    items: [
  ...
  },
  {
    id: 'music',
    label: 'Music',
    intro: 'Music videos, stills and videography selections.',
    items: [
  ...
  {
    id: 'assisting',
    label: 'Assisting / Superdry',
    intro: 'Selected assisting work for SUPERDRY.',
    items: [
  ...
  },
  {
    id: 'big-sky',
    label: 'Big Sky',
    intro: 'Big Sky content and rig-led visual selections.',
    items: [
  ...
  ...section,
  items: section.items.map(([title, id]) => ({ title, id, embedUrl: file(id) }))
}));
